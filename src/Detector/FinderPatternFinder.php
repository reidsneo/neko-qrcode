...
final class FinderPatternFinder{
	...
	/** @var \Neko\QRCode\Detector\FinderPattern[] */
	...
	/**
	 * @return \Neko\QRCode\Detector\FinderPattern[]
	 */
	...
	/**
	 * @return \Neko\QRCode\Detector\FinderPattern[] the 3 best FinderPatterns from our list of candidates. The "best" are
	 *         those that have been detected at least #CENTER_QUORUM times, and whose module
	 *         size differs from the average among those patterns the least
	 * @throws \Neko\QRCode\Detector\QRCodeDetectorException if 3 such finder patterns do not exist
	 */
	 ...
	 *
	 * @param \Neko\QRCode\Detector\FinderPattern[] $patterns array of three FinderPattern to order
	 *
	 * @return \Neko\QRCode\Detector\FinderPattern[]
	 */
