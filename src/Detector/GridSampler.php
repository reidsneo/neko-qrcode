...
namespace Neko\QRCode\Detector;

use Neko\QRCode\Data\QRMatrix;
use Neko\QRCode\Decoder\BitMatrix;
use Throwable;
...
final class GridSampler{
	 ...
	 *
	 * @param \Neko\QRCode\Decoder\BitMatrix $matrix image into which the points should map
	 * @param float[]                              $points actual points in x1,y1,...,xn,yn form
	 *
	 * @throws \Neko\QRCode\Detector\QRCodeDetectorException if an endpoint is lies outside the image boundaries
	 */
	 ...
	 * image space.
	 *
	 * @return \Neko\QRCode\Decoder\BitMatrix representing a grid of points sampled from the image within a region
	 *   defined by the "from" parameters
	 * @throws \Neko\QRCode\Detector\QRCodeDetectorException if image can't be sampled, for example, if the transformation defined
