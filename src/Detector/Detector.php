...
use Neko\QRCode\Decoder\{Binarizer, LuminanceSourceInterface};
use Neko\QRCode\Common\Version;
...
final class Detector{
	 ...
	 *
	 * @throws \Neko\QRCode\Detector\QRCodeDetectorException
	 */
	 ...
	 *
	 * @return \Neko\QRCode\Detector\AlignmentPattern|null if found, or null otherwise
	 */
