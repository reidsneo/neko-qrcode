...
final class AlignmentPatternFinder{
	...
	/** @var \Neko\QRCode\Detector\AlignmentPattern[] */
	private array $possibleCenters;

	/**
	 * Creates a finder that will look in a portion of the whole image.
	 *
	 * @param \Neko\QRCode\Decoder\BitMatrix $matrix     image to search
	 ...
	 *
	 * @return \Neko\QRCode\Detector\AlignmentPattern|null
	 */
	 ...
	 *
	 * @return \Neko\QRCode\Detector\AlignmentPattern|null if we have found the same pattern twice, or null if not
	 */
