...
use Neko\QRCode\Common\{BitBuffer, EccLevel, Mode, Version};
...
final class QRData{
	 ...
	 *
	 * @var \Neko\QRCode\Settings\SettingsContainerInterface|\Neko\QRCode\QROptions
	 */
	 ...
	 *
	 * @param \Neko\QRCode\Data\QRDataModeInterface[] $dataSegments
	 */
	 ...
	 *
	 * @throws \Neko\QRCode\QRCodeException on data overflow
	 */
