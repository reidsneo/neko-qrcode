...
namespace Neko\QRCode\Common;

use Neko\QRCode\QRCodeException;
...
final class ReedSolomonDecoder{
	 ...
	 *
	 * @return int[]
	 * @throws \Neko\QRCode\QRCodeException if decoding fails for any reason
	 */
	...
	/**
	 * @return \Neko\QRCode\Common\GenericGFPoly[] [sigma, omega]
