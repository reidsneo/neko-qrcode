...
final class GenericGFPoly{
	 ...
	 *
	 * @throws \Neko\QRCode\QRCodeException if argument is null or empty, or if leading coefficient is 0 and this
	...
	/**
	 * @return \Neko\QRCode\Common\GenericGFPoly[] [quotient, remainder]
