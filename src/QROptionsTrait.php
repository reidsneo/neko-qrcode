...
use Neko\QRCode\Output\QROutputInterface;
use Neko\QRCode\Common\{EccLevel, MaskPattern, Version};
...
trait QROptionsTrait{
	 ...
	 * - QRFpdf:    FPDF
	 *
	 * @see \Neko\QRCode\Output\QROutputInterface::dump()
	 *
	 * @var bool
	 */
	 ...
	 * toggle transparency
	 *
	 * - QRGdImage and QRImagick: the given {@see \Neko\QRCode\QROptions::$transparencyColor $transparencyColor} is set as transparent
	 *
	...
	/**
	 * Sets a transparency color for when {@see \Neko\QRCode\QROptions::$imageTransparent QROptions::$imageTransparent} is set to true.
	 * Defaults to {@see \Neko\QRCode\QROptions::$bgColor QROptions::$bgColor}.
	 *
