...
namespace Neko\QRCode;

use Neko\QRCode\Common\{EccLevel, ECICharset, MaskPattern, Mode, Version};
use Neko\QRCode\Data\{
	AlphaNum, Byte, ECI, Hanzi, Kanji, Number, QRData, QRDataModeInterface, QRMatrix
};
use Neko\QRCode\Decoder\{Decoder, DecoderResult, GDLuminanceSource, IMagickLuminanceSource, LuminanceSourceInterface};
use Neko\QRCode\Output\{QRCodeOutputException, QROutputInterface};
use Neko\QRCode\Settings\SettingsContainerInterface;
...
class QRCode{
	 ...
	 * @see \Neko\QRCode\Common\Version::AUTO
	 * @var int
	 */
	 ...
	 * @see \Neko\QRCode\Common\MaskPattern::AUTO
	 * @var int
	 */
	 ...
	 * @see \Neko\QRCode\Common\EccLevel::L
	 * @var int
	 */
	 ...
	 * @see \Neko\QRCode\Common\EccLevel::M
	 * @var int
	 */
	 ...
	 * @see \Neko\QRCode\Common\EccLevel::Q
	 * @var int
	 */
	 ...
	 * @see \Neko\QRCode\Common\EccLevel::H
	 * @var int
	 */
	 ...
	 * @see \Neko\QRCode\Output\QROutputInterface::MARKUP_HTML
	 * @var string
	 */
	 ...
	 * @see \Neko\QRCode\Output\QROutputInterface::MARKUP_SVG
	 * @var string
	 */
	 ...
	 * @see \Neko\QRCode\Output\QROutputInterface::GDIMAGE_PNG
	 * @var string
	 */
	 ...
	 * @see \Neko\QRCode\Output\QROutputInterface::GDIMAGE_JPG
	 * @var string
	 */
	 ...
	 * @see \Neko\QRCode\Output\QROutputInterface::GDIMAGE_GIF
	 * @var string
	 */
	 ...
	 * @see \Neko\QRCode\Output\QROutputInterface::STRING_JSON
	 * @var string
	 */
	 ...
	 * @see \Neko\QRCode\Output\QROutputInterface::STRING_TEXT
	 * @var string
	 */
	 ...
	 * @see \Neko\QRCode\Output\QROutputInterface::IMAGICK
	 * @var string
	 */
	 ...
	 * @see \Neko\QRCode\Output\QROutputInterface::FPDF
	 * @var string
	 */
	 ...
	 * @see \Neko\QRCode\Output\QROutputInterface::EPS
	 * @var string
	 */
	 ...
	 * @see \Neko\QRCode\Output\QROutputInterface::CUSTOM
	 * @var string
	 */
	 ...
	 * @see \Neko\QRCode\Output\QROutputInterface::MODES
	 * @var string[]
	 */
	 ...
	 *
	 * @var \Neko\QRCode\QROptions|\Neko\QRCode\Settings\SettingsContainerInterface
	 */
	 ...
	 *
	 * @var \Neko\QRCode\Data\QRDataModeInterface[]
	 */
	...
	public function render(string $data = null, string $file = null){
		...
		if($data !== null){
			/** @var \Neko\QRCode\Data\QRDataModeInterface $dataInterface */
	 ...
	 *
	 * @throws \Neko\QRCode\Data\QRCodeDataException
	 */
	 ...
	 * @see \Neko\QRCode\QRCode::getQRMatrix()
	 * @codeCoverageIgnore
	 */
	 ...
	 *
	 * @throws \Neko\QRCode\Output\QRCodeOutputException
	 */
	 ...
	 * @see \Neko\QRCode\Data\Number::validateString()
	 * @codeCoverageIgnore
	 */
	 ...
	 * @see \Neko\QRCode\Data\AlphaNum::validateString()
	 * @codeCoverageIgnore
	 */
	 ...
	 * @see \Neko\QRCode\Data\Kanji::validateString()
	 * @codeCoverageIgnore
	 */
	 ...
	 * @see \Neko\QRCode\Data\Byte::validateString()
	 * @codeCoverageIgnore
	 */
	 ...
	 *
	 * @throws \Neko\QRCode\QRCodeException
	 */
