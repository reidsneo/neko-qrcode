...
namespace Neko\QRCode\Decoder;

use Neko\QRCode\Common\{BitBuffer, EccLevel, MaskPattern, Mode, ReedSolomonDecoder, Version};
use Neko\QRCode\Data\{AlphaNum, Byte, ECI, Hanzi, Kanji, Number};
use Neko\QRCode\Detector\Detector;
use Throwable;
...
final class Decoder{
	 ...
	 *
	 * @throws \Throwable|\Neko\QRCode\Decoder\QRCodeDecoderException
	 */
	...
	/**
	 * @throws \Neko\QRCode\Decoder\QRCodeDecoderException
	 */
